  ...
  public allEvents = [
    {
      ...
      time: "2016 - 2014",
      desc: `Created and updated Cladwell’s consumer focus web applications to work with existing products, optimized for mobile usage, maintained a modular structure and UI library to support future features and improvements. Used AngularJS and React frameworks to connect with Node.js processes utilizing MySQL and NoSQL data management. Turned Cladwell’s prototypes and designs into responsive applications with full-stack flexibility.\r\n
      Project managed 20 sprints using a 10-day agile process, outlined product objectives, and facilitated team alignment and product direction meetings. Collaborated with designers on over 100 new product features, more than 250 UI and UX improvements with on-time, on-spec delivery.\r\n
      Worked directly with marketing managers to aid with qualitative testing of marketing initiatives and product improvements. Integrated multiple third-party analytic products and generated reports to track and aggregate data from overall traffic, acquisition, and user behavior in order to influence brand and product direction during weekly meetings with all departments.\r\n
      Directly contributed to growing user-base; 250k free accounts and 15k paid subscriptions generating an ARR projected over $1MM in 2016.\r\n
      Worked with an off-site initiative with Macy's in 2015 and participated in Batch 17 of 500 Startups in Mountain View, California.`,
      preview_image: null
    },
    {
      name: "CoupSmart",
